-- Compatibility made by Aurélien LEQUOY (from ./procedure/diagnostics.sql)
...
CREATE DEFINER='root'@'localhost' PROCEDURE diagnostics (
    ...
    COMMENT '
             ...
             Versions supported:
                * MariaDB 10.0: 10.0.21 and later
                * MariaDB 10.1: 10.1.6 and later
...
BEGIN
    ...
    UNION ALL
    SELECT 'Server UUID' AS 'Name', 'N/A' AS 'Value'
    UNION ALL
