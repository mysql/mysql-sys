 ...
 * | System Time                          | NOW()                                         |       1 | 2014-12-08 12:39:18 |
 * | System Time                          | UNIX_TIMESTAMP()                              |       1 | 1418002758          |
 * +--------------------------------------+-----------------------------------------------+---------+---------------------+
...
SELECT 'System Time' AS Type, 'NOW()' AS Variable_name, TRUE AS Enabled, NOW() AS Variable_value
) UNION ALL (
SELECT 'System Time' AS Type, 'UNIX_TIMESTAMP()' AS Variable_name, TRUE AS Enabled, UNIX_TIMESTAMP() AS Variable_value
)
