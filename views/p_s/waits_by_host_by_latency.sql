...
/*
 * View: waits_by_host_by_latency_raw
 *
 * Lists the top wait events by their total latency, ignoring idle (this may be very large) per host.
 *
 * mysql> select * from x$waits_by_host_by_latency;
 * +------+-----------------------------------------------------+--------+----------------+-------------+--------------+
 * | host | event                                               | total  | total_latency  | avg_latency | max_latency  |
 * +------+-----------------------------------------------------+--------+----------------+-------------+--------------+
 * | hal1 | wait/io/file/sql/file_parser                        |  13745 | 60462025415480 |  4398837508 | 231881092170 |
 * | hal1 | wait/io/file/innodb/innodb_data_file                |   4699 |  3023248450820 |   643381037 |  46928334180 |
 * | hal1 | wait/io/file/sql/FRM                                |  11467 |  2600067790580 |   226743257 |  61718277920 |
 * | hal1 | wait/io/file/myisam/dfile                           |  26776 |   746701506200 |    27886690 | 308785046960 |
 * | hal1 | wait/io/file/myisam/kfile                           |   7126 |   462661061590 |    64925432 |  88756408780 |
 * | hal1 | wait/io/file/sql/dbopt                              |    179 |   137577467690 |   768589146 |  15457199810 |
 * | hal1 | wait/io/file/csv/metadata                           |      8 |    86599791590 | 10824973666 |  50322529270 |
 * | hal1 | wait/synch/mutex/mysys/IO_CACHE::append_buffer_lock | 798080 |    66461175430 |       82940 |    161028010 |
 * | hal1 | wait/io/file/sql/binlog                             |     19 |    49110632610 |  2584770058 |   9400449760 |
 * | hal1 | wait/io/file/sql/misc                               |     26 |    22380676630 |   860795052 |  15298475270 |
 * | hal1 | wait/io/file/csv/data                               |      4 |      297460540 |    74365135 |    111931300 |
 * | hal1 | wait/synch/rwlock/sql/MDL_lock::rwlock              |    944 |      287862120 |      304616 |       874640 |
 * | hal1 | wait/io/file/archive/data                           |      4 |       82713800 |    20678450 |     40738620 |
 * | hal1 | wait/synch/mutex/myisam/MYISAM_SHARE::intern_lock   |     60 |       12211030 |      203203 |       512720 |
 * | hal1 | wait/synch/mutex/innodb/trx_mutex                   |     81 |        5926440 |       73138 |       252590 |
 * +------+-----------------------------------------------------+--------+----------------+-------------+--------------+
 *
 */
